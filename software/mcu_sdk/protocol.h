...
/******************************************************************************
                            1:修改产品信息                
******************************************************************************/
#define PRODUCT_KEY "Ye8EgbWEAWI9DgkI"    //开发平台创建产品后生成的16位字符产品唯一标识
...
#define WIFI_UART_QUEUE_LMT             24              //数据接收队列大小,如MCU的RAM不够,可缩小
...
//模式(可下发可上报)
//备注:Manual手动模式；Auto自动模式；Comfortable舒适模式；Sleep睡眠模式；Quick速净模式；Super超净模式; Monitor监测模式
#define DPID_MODE 2
//风速(可下发可上报)
//备注:
#define DPID_SPEED 3
...
//室内湿度(只上报)
//备注:
#define DPID_HUMIDITY 13
//TVOC(只上报)
//备注:
#define DPID_TVOC 14
//累计运行时间(只上报)
//备注:
#define DPID_TOTALTIME 17
//故障上报(只上报)
//备注:
